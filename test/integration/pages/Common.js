sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("project1/project1/app", ".html");
		...
		return Opa5.extend("project1.project1.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["project1/project1/localService/mockserver"], function (mockserver) {
